...
export default function AccountPage() {
  ...
  if (!isLoaded) {
    return (
      <div className="bg-brand-navy min-h-screen pt-20 flex items-center justify-center">
  ...
  if (!isSignedIn) {
    return (
      <>
        ...
        <div className="bg-brand-navy min-h-screen pt-20 flex items-center justify-center px-4">
