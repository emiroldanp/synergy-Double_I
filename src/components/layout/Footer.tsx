        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a
                href="#"
                aria-label="Instagram [PLACEHOLDER — confirmar con Irving]"
                className="text-ash hover:text-dragon transition-colors"
              >
              ...
              <a
                href="#"
                aria-label="Facebook [PLACEHOLDER — confirmar con Irving]"
                className="text-ash hover:text-dragon transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="#"
                aria-label="TikTok [PLACEHOLDER — confirmar con Irving]"
                className="text-ash hover:text-dragon transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-exo text-ash">
              ...
              <li className="text-ash/60 text-xs italic">
                [PLACEHOLDER — confirmar redes con Irving]
              </li>
            </ul>
          </div>
        </div>
